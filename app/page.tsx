...
export default function Home() {
  ...
  const inputClass =
    'bg-white/[0.03] border-white/[0.1] text-white rounded-xl h-12 text-base sm:text-lg focus:border-[#6366f1] focus:ring-2 focus:ring-[#6366f1]/20 transition-all shadow-inner placeholder:text-slate-500/70';
  const selectTriggerClass =
    'bg-white/[0.03] border-white/[0.1] text-white rounded-xl h-12 text-base sm:text-lg focus:border-[#6366f1] focus:ring-2 focus:ring-[#6366f1]/20 transition-all shadow-inner';
  const textareaClass =
    'bg-white/[0.03] border-white/[0.1] text-white rounded-xl min-h-32 text-base sm:text-lg focus:border-[#6366f1] focus:ring-2 focus:ring-[#6366f1]/20 transition-all shadow-inner placeholder:text-slate-500/70';
    ...
    <div className="min-h-screen text-white relative bg-[#020617]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
        ...
        <section className="text-center mb-24 sm:mb-32">
          ...
          <AnimatedButton onClick={scrollToForm}>無料相談を依頼する</AnimatedButton>
        </section>
