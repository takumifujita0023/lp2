            ...
            <GlassCard hover={false}>
              <div className="p-8 sm:p-10">
                ...
                <div className="space-y-3">
                  ...
                  >
                    {['企画', '台本', '撮影', '編集', '投稿代行', '分析', '内製化支援'].map((item, index) => (
                      <motion.span
                        key={item}
                        className="bg-white/[0.08] backdrop-blur-sm border border-white/[0.15] px-5 py-3 rounded-xl text-[#e2e8f0] text-base sm:text-lg font-medium hover:bg-white/[0.12] hover:border-[#6366f1]/60 hover:shadow-lg hover:shadow-[#6366f1]/20 transition-all"
            ...
            {[
              ...
              <GlassCard key={index} delay={index * 0.15}>
                <div className="p-6 sm:p-8 text-center">
                  <motion.h3
                    className="text-lg sm:text-xl font-bold bg-gradient-to-r from-[#4f46e5] to-[#22d3ee] bg-clip-text text-transparent mb-4"
                    whileHover={{ scale: 1.05 }}
                  >
                    {item.title}
                  </motion.h3>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-white/[0.1]">
                      <th className="text-left p-4 sm:p-6 text-[#94a3b8] font-semibold text-sm sm:text-base">項目</th>
                      ...
                      <th className="text-center p-4 sm:p-6 text-[#94a3b8] font-semibold text-sm sm:text-base">他社</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      >
                        ...
                        <td className="p-4 sm:p-6 text-center relative">
                          ...
                          <motion.div whileHover={{ scale: 1.15 }} className="relative inline-flex items-center justify-center">
                            <div className="relative w-8 h-8">
                              <Circle className="absolute inset-0 h-8 w-8 text-[#6366f1] fill-none drop-shadow-[0_0_8px_rgba(99,102,241,0.6)]" strokeWidth={2.5} />
                              <Circle className="absolute h-5 w-5 text-[#6366f1] fill-none" strokeWidth={2.5} style={{ top: '6px', left: '6px' }} />
                            </div>
                          </motion.div>
                        </td>
                        <td className="p-4 sm:p-6 text-center">
                          {row.them === 'best' && (
                            <div className="relative inline-flex items-center justify-center">
                              <div className="relative w-8 h-8">
                                <Circle className="absolute inset-0 h-8 w-8 text-[#cbd5e1] fill-none" strokeWidth={2.5} />
                                <Circle className="absolute h-5 w-5 text-[#cbd5e1] fill-none" strokeWidth={2.5} style={{ top: '6px', left: '6px' }} />
                              </div>
                            </div>
                          )}
                          {row.them === 'good' && (
        ...
        <section className="mb-24 sm:mb-32 mr-0 sm:mr-8">
          ...
          <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
            {[
              ...
              <GlassCard key={item.step} delay={index * 0.1} hover={false}>
                <div className="p-6 sm:p-8">
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <p className="text-[#cbd5e1] text-lg sm:text-xl font-semibold">{item.title}</p>
                  </div>
                </div>
              </GlassCard>
            ))}
            ...
            <GlassCard hover={false} className="max-w-3xl mx-auto relative z-10">
              <div className="p-6 sm:p-10 lg:p-12">
                <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                  <div>
                    <Label htmlFor="company" className="text-[#cbd5e1] mb-2 block text-base sm:text-lg">
                  ...
                  <div>
                    <Label htmlFor="email" className="text-[#cbd5e1] mb-2 block text-base sm:text-lg">
                  ...
                  <div>
                    <Label htmlFor="purpose" className="text-[#cbd5e1] mb-2 block text-base sm:text-lg">
                      目的
                    </Label>
                  ...
                  <div>
                    <Label htmlFor="timeline" className="text-[#cbd5e1] mb-2 block text-base sm:text-lg">
                      開始時期
                    </Label>
                  ...
                  <div>
                    <Label htmlFor="message" className="text-[#cbd5e1] mb-2 block text-base sm:text-lg">
                      自由記述
                    </Label>
                    <Textarea
                      id="message"
